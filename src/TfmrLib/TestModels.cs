...
namespace TfmrLib
{
    public static class TestModels
    {
                        ...
                        Segments =
                        {
                            new WindingSegment
                            {
                                ...
                                Geometry = new InterleavedDiscWindingGeometry
                                {
                                    ...
                                    Interleaving = new() { new InterleavingSchedule.InterleavedGroup(1, InterleavingSchedule.InterleavingType.FullStearns), 
                                                            new InterleavingSchedule.InterleavedGroup(1, InterleavingSchedule.InterleavingType.PartialStearns), 
                                                            new InterleavingSchedule.InterleavedGroup(1, InterleavingSchedule.InterleavingType.None) },
        ...
        public static Transformer ModelWindingSmall(int num_discs, int turns_per_disc)
        {
            var transformer = new Transformer
            {
                Core = new Core
                        ...
                        Segments =
                        {
                            new WindingSegment
                            {
                                ...
                                Geometry = new DiscWindingGeometry
                                {
                                    ...
                                    NumTurns = num_discs*turns_per_disc,
                                    SpacerPattern = new RadialSpacerPattern
                                    {
                                        SpacerWidth_mm = 20.0,
                                        NumSpacers_Circumference = 16,
                                        Elements = new List<SpacerPatternElement>
                                        {
                                            new() { Count = num_discs-1, SpacerHeight_mm = Conversions.in_to_mm(0.188) }
                                        }
                                    },
                                    InnerRadius_mm = Conversions.in_to_mm(15.25),
                                    DistanceAboveBottomYoke_mm = Conversions.in_to_mm(15.0)
            ...
            var transformer = new Transformer
            {
                ...
                Windings =
                {
                    ...
                    new Winding
                    {
                        ...
                        Terminals =
                        {
                            new Terminal { Label="Y1" },
                            new Terminal { Label="YN" }
                        },
                        Segments =
                        {
                            new WindingSegment
