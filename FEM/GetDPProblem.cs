...
namespace TfmrLib.FEM
{
    ...
    public class GetDPAxiMagProblem : GetDPProblem
    {
        ...
        protected override void WriteGetDPFile(string filename)
        {
            base.WriteGetDPFile(filename);

            var f = File.AppendText(model_prefix + "case.pro");
            f.WriteLine();
            ...
            f.WriteLine("      Integral { [ sigma[] * Dof{ur} / (2*Pi) , {a} ];");
            f.WriteLine("        In Vol_C_Mag; Jacobian Vol; Integration Gauss_v; }");
            ...
            f.WriteLine("        In Vol_C_Mag; Jacobian Vol; Integration Gauss_v; }");
            f.WriteLine("      Integral { [ sigma[] * Dof{ur} / (2*Pi) , {ur} ];");
            f.WriteLine("        In Vol_C_Mag; Jacobian Vol; Integration Gauss_v; }");
